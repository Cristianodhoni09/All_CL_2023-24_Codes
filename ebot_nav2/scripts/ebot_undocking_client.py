...
class UnDockingClientNode(Node):

    def __init__(self):
        super().__init__('undocking_client')
        self.undock_client = self.create_client(DockSw, 'dock_control')
    ...
    def send_undocking_request(self):
        ...
        request.orientation = rack_yaw
        request.rack_no = "rack1"
...
def main(args=None):
    ...
    undocking_client_node = UnDockingClientNode()
    rclpy.spin(undocking_client_node)
    undocking_client_node.destroy_node()
    rclpy.shutdown()
